...
class IScannerCallback {
  public:
    ...
    virtual void onBatchScanResults(std::vector<ScanResult*> batchResults){}
    virtual void onFoundOrLost(bool onFound, ScanResult *scanResult){}
    virtual void onScanManagerErrorCallback(int errorCode){}
};
}
#endif

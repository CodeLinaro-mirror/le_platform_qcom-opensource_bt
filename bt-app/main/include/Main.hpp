...
/*    {PLAY,                  "start",            ZERO_PARAM,   "start"},
    ...
    {NOW_PLAYING_CONTENT_CHANGED,"avrcp_now_playing_content_changed",  ZERO_PARAM,   "avrcp_now_playing_content_changed"},
  ...
  /*  {ADDR_PLAYER_CHANGE,    "addrplayerchange", ONE_PARAM,
    ...
    {AVAIL_PLAYER_CHANGE,   "avrcp_availplayerchange",ZERO_PARAM,   "avrcp_availplayerchange"},
    {BIGGER_METADATA,       "avrcp_biggermetadata",   ZERO_PARAM,   "avrcp_biggermetadata info:enables bigger avrcp metadata"},
    {SET_EQUALIZER_VAL,     "avrcp_setequalizerval",  ONE_PARAM,     "avrcp_setequalizerval<space><val> (1/2)"},
...
UserMenuList HfpClientMenu[] = {
    ...
    {REJECT_CALL,           "reject_incoming_call",   ZERO_PARAM,   "reject_incoming_call"},
    {END_CALL,              "end_active_call",      ZERO_PARAM,   "end_active_call"},
    {HOLD_CALL,             "hold_active_call",     ZERO_PARAM,   "hold_active_call"},
    {HOLD_CALL,             "unhold_held_call",     ZERO_PARAM,   "unhold_held_call"},
    {RELEASE_HELD_CALL,     "reject_incoming_call_when_active_call_present", ZERO_PARAM,   "reject_incoming_call_when_active_call_present"},
    {RELEASE_HELD_CALL,     "end_held_call", ZERO_PARAM,   "end_held_call"},
    {RELEASE_ACTIVE_ACCEPT_WAITING_OR_HELD_CALL,  "end_active_call_and_accept_waiting_or_held_call",
      ZERO_PARAM,"end_active_call_and_accept_waiting_or_held_call"},
    ...
    {RELEASE_SPECIFIED_ACTIVE_CALL, "end_specified_active_call", ONE_PARAM,
    ...
    {PUT_INCOMING_CALL_ON_HOLD, "put_incoming_call_on_hold_when_no_other_call_present", ZERO_PARAM,   "put_incoming_call_on_hold_when_no_other_call_present"},
    {ACCEPT_HELD_INCOMING_CALL, "accept_held_incoming_call_when_no_other_call_present", ZERO_PARAM,   "accept_held_incoming_call_when_no_other_call_present"},
    {REJECT_HELD_INCOMING_CALL, "reject_held_incoming_call_when_no_other_call_present", ZERO_PARAM,   "reject_held_incoming_call_when_no_other_call_present"},
    ...
    {START_VR,              "start_voice_recognition",      ZERO_PARAM,   "start_voice_recognition"},
    {STOP_VR,               "stop_voice_recognition",       ZERO_PARAM,   "stop_voice_recognition"},
